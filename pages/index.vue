			...
			<div class="container">
				<div class="header-in">
					<div class="header-left">
						...
						<button id="header-btn-desktop" data-meta="lead-open" type="button" @click="scrollToOrderForm" class="header-btn btn--main" data-aos="fade-right" data-aos-delay="300">
							Маслаҳат олиш
						</button>
					...
					<button id="header-btn-mobile" data-meta="lead-open" type="button" @click="scrollToOrderForm" class="header-btn btn--main header--mobile" data-aos="fade-right" data-aos-delay="300">
						Маслаҳат олиш
					</button>
				</div>
			</div>
		...
		<section class="benefits">
			...
			<div class="container">
				...
				<div class="who-bottom">
					...
					<button id="benefits-btn" data-meta="lead-open" type="button" @click="scrollToOrderForm" class="who-bottom__btn btn--main">
						Маслаҳат олиш
					</button>
		...
		<section class="order">
			<div class="container">
				...
				<div class="who-bottom">
					...
					<button id="order-btn" data-meta="lead-open" type="button" @click="scrollToOrderForm" class="who-bottom__btn btn--main">Маслаҳат олиш </button>
					<div class="who-bottom__img2">
						<img
							src="https://optim.tildacdn.one/tild6639-3835-4564-b263-633834316438/-/resize/302x/-/format/webp/Leaves_Overlay_1_5.png"
							width="302" height="auto" alt="Img" />
